...
from paquete_cpp.action import VarAction      # Añadir interfaz usada en el servicio.
...
class Clase_Cliente_Accion(Node):
    ...
    # Callback que en la que el servidor dice si el "goal" es aceptado o no.
    ...
    # Callback que se llama cuando la acción del servidor se termina devolviendo el resultado
